...
export const visualPresets = {
  ...
  'tech-directory': {
    label: 'Vintage Summer Editorial',
    mood: 'warm, bright, useful',
    fontDirection: 'modern editorial sans with vintage color accents',
    colors: {
      background: '#f1dbbf',
      foreground: '#aa5656',
      muted: '#aa5656',
    ...
    shape: 'clean editorial grids with warm vintage accents',
  },
  'retro-bulletin': {
